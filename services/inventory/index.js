...
const packageDefination = protoLoader.loadSync('proto/inventory.proto', {
...
server.bindaAsync('127.0.0.1:3002', grpc.ServerCredentials.createInsecure(), () => {
    console.log('Inventory Service runing at http://127.0.0.1:3002');
